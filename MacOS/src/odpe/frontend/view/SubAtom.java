...
public class SubAtom extends WidgetView {
    ...
    public SubAtom(Node n, WidgetView[] rands) {
        this.syn = n.getSyntax();
        this.rands = rands;
        this.n = n;
    }
    
    public SubAtom(Node n, WidgetView[] rands, ViewableObject operatorSymbol) {
        this.syn = n.getSyntax();
        this.rands = rands;
        this.n = n;
    ...
    public JComponent getWidget() {
        return new SubJoin(rands, syn, n, operatorSymbol);
    }
    ...
    public static class SubJoin extends JPanel implements MouseListener {
        ...
        SubJoin(WidgetView[] rands, SyntaxElement syn, Node n, ViewableObject operatorSymbol){
            ...
            if(widgets.size() == 1) {
                ...
                for(JPanel p : panels) {
                    ...
                    if(panels.indexOf(p) != panels.size()-1) {
                        ...
                        JLabel lbl = new JLabel("<html><span style='font-size:14px; font-weight:50;'>"+operatorSymbol.getTextOutputView()+"</span></html>");
