...
Please name the file to 'maude.linux64' for Linux (should be already)
Please name the file to 'maude.darwin64' for MacOS (should be already)
...
- Enter a >['c-down]> [a,a] and press OK
